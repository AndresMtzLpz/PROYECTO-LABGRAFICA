...
void CrearCubo()
{
	...
	//agregar normales en el eje X la normal va inversa, en el caso del eje z va inversa, 
	//en el caso del eje y va en sentido normal
...
//contador de luces puntuales
	...
	pointLights[0] = PointLight(.0f, 1.0f, 0.0f,
		0.0f, 1.0f,
		3.0f, 0.0f, 0.0f,
